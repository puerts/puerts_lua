...
public:
    ...
    virtual void UnBindCppObject(lua_State *L, JSClassDefinition* ClassDefinition, void* Ptr) override;

    virtual void BindCppObject(lua_State *L, JSClassDefinition* ClassDefinition, void* Ptr, bool PassByPointer) override;
...
private:
    ...
    int GetMetaRefOfClass(lua_State *L, const JSClassDefinition* ClassDefinition);
        
    void BindCppObject(lua_State *L, JSClassDefinition* ClassDefinition, void* Ptr, bool PassByPointer, FObjectCacheNode* CacheNodePtr);
};

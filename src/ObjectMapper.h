...
{
public:
    virtual void BindCppObject(lua_State *L, JSClassDefinition* ClassDefinition, void* Ptr, bool PassByPointer) = 0;

    virtual void UnBindCppObject(lua_State *L, JSClassDefinition* ClassDefinition, void* Ptr) = 0;
